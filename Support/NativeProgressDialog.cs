...
{
    /// <summary>
    /// Uses the <see cref="Win32IProgressDialog"/> to show a operation progress dialog.
    /// The minimum supported operating systems are Windows 2000 and Windows XP.
    /// </summary>
    public class NativeProgressDialog
    {
        ...
        /// <summary>
        /// This font size is larger than the others, so we'll add some trim logic.
        /// </summary>
        public string Line1
        {
            get => this.line1;
            set
            {
                if (!string.IsNullOrEmpty(value) && value.Length > 50)
                    this.line1 = $"{value.Substring(0, 50)}…";
                else
                    this.line1 = value;
