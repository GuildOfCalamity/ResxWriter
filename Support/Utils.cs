...
using static ResxWriter.NativeProgressDialog;
...
namespace ResxWriter
{
    ...
    public class FileDeletion
    {
        ...
        // https://learn.microsoft.com/en-us/windows/win32/api/shobjidl_core/nf-shobjidl_core-ifileoperation-setoperationflags#parameters
        /// <summary>
        /// The desired file operation.
        /// </summary>
        const int FO_DELETE = 0x03;
        /// <summary>
        /// Do not show a dialog during the process.
        /// </summary>
        const int FOF_SILENT = 0x04;
        /// <summary>
        ...
        /// </summary>
        const int FOF_SIMPLEPROGRESS = 0x0100;
        /// <summary>
        ...
        /// <returns>zero if successful, non-zero value otherwise</returns>
        public static int SendToRecycleBin(string path)
        {
            ...
            shf.pFrom = path + "\0" + "\0"; // path must be terminated with null
    ...
    { 
        ...
        void PreDeleteItem(uint dwFlags, IShellItem psiItem); void PostDeleteItem(uint dwFlags, IShellItem psiItem, uint hrDelete, IShellItem psiNewlyCreated); 
    ...
    { 
        ...
        /// </summary>
        /// <param name="dwOperationFlags"></param>
        ...
        /// <summary>
        /// https://learn.microsoft.com/en-us/windows/win32/api/shobjidl_core/nf-shobjidl_core-ifileoperation-copyitems
        /// </summary>
        /// <param name="psiItem"></param>
        /// <param name="psiDestinationFolder"></param>
        /// <param name="pszCopyName"></param>
        /// <param name="pfopsItem"></param>
    ...
    { 
        ...
        public FileOperation(IFileOperationProgressSink callbackSink) : this(callbackSink, null) { }
        public FileOperation(IFileOperationProgressSink callbackSink, IWin32Window owner) { }
